import { ScrapingOptions, ExportFormat } from '../../types/index.ts';
...
export const parseArguments = (): ScrapingOptions => {
  ...
  args.forEach((arg: string) => {
    ...
    if (arg.startsWith('fileType=')) {
      ...
      if (Object.values(ExportFormat).includes(fileType as ExportFormat)) {
        options.fileType = fileType as ExportFormat;
      }
    }
