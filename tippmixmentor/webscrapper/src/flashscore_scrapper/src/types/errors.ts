...
export interface ErrorContext {
  operation: string;
  type?: ErrorType; // Added type property
  message?: string; // Added message property
  url?: string;
  matchId?: string;
  attempt?: number; // Made optional as it might not always be available at initial error creation
  timestamp?: Date; // Made optional as it's often generated by the error handler
  userAgent?: string;
  sessionId?: string;
