  ...
  useEffect(() => {
    const checkUserSession = async () => {
      ...
      try {
        ...
        // Ha hiba történik (pl. 401 Unauthorized, mert nincs érvényes session, vagy hálózati hiba),
        // akkor nincs bejelentkezett felhasználó.
        // A globális interceptor kezeli a 401-et, de itt is biztosítjuk a user nullázását.
        if (axios.isAxiosError(error) && error.response?.status === 401) {
          // Ha kifejezetten 401 jött a /me végpontról, az azt jelenti, nincs aktív session.
          setUser(null)
          setScannedDirsCount(0) // Nincs felhasználó, nincs mappa
        } else {
          // Egyéb hibák esetén is nullázzuk, és logoljuk a hibát.
          console.error('Hiba a felhasználói munkamenet ellenőrzésekor:', error.message)
          setUser(null)
          setScannedDirsCount(0) // Nincs felhasználó, nincs mappa
        }
      } finally {
