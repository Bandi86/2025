...
class PDFHandler(FileSystemEventHandler):
    ...
    def process_new_pdf(self, pdf_path):
        ...
        try:
            ...
            # process_all_pdfs.py futtatása (a projekt gyökérből)
            cmd = ["python3", "scripts/process_all_pdfs.py"]
            result = subprocess.run(
                cmd,
                cwd=self.script_dir.parent,  # Egy szinttel feljebb a gyökér mappába
                capture_output=True,
                text=True
            )
