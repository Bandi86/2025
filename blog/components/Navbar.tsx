    ...
    <nav className="bg-white shadow-lg">
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <a href="/articles" className="border-b-2 border-transparent text-gray-600 hover:border-indigo-500 hover:text-gray-900 inline-flex items-center px-1 pt-1 text-sm font-medium transition duration-150 ease-in-out">
                Articles
              </a>
      ...
      <div className="sm:hidden" id="mobile-menu">
        <div className="pt-2 pb-3 space-y-1">
          ...
          <a href="/articles" className="border-l-4 border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 block pl-3 pr-4 py-2 text-base font-medium">Articles</a>
